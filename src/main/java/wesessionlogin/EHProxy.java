...
public interface EHProxy {
     ...
     * @param partyTYPE
     * @param rejectedDATE
     * @param clientSCREENRESOLUTION
     * @param trxNORMALIZEDDATETIME
     * @param rejectedTRXIND
     * @param trxKEY
     * @param ipADDRESS
     * @param rejectedTYPECD
     * @param webSessionLoginOut
     * @param httpHEADERFIELDS
     * @param calcWEBDEVICEID
     * @param partyKEY
     * @param webDEVICEID
     * @param resendDUETOFAILUREIND
     * @return
     *     returns wsclient.EHResult
     */
    @WebMethod(operationName = "FF_WS_evaluateWebSessionLogin_V12")
    @WebResult(name = "FF_WS_evaluateWebSessionLogin_V12Return", partName = "FF_WS_evaluateWebSessionLogin_V12Return")
    public EHResult ffWSEvaluateWebSessionLoginV12(
            @WebParam(name = "TRX_KEY", partName = "TRX_KEY")
                    String trxKEY,
            @WebParam(name = "TRX_NORMALIZED_DATE_TIME", partName = "TRX_NORMALIZED_DATE_TIME")
                    String trxNORMALIZEDDATETIME,
            @WebParam(name = "PARTY_KEY", partName = "PARTY_KEY")
                    String partyKEY,
            @WebParam(name = "IP_ADDRESS", partName = "IP_ADDRESS")
                    String ipADDRESS,
            @WebParam(name = "SESSION_KEY", partName = "SESSION_KEY")
                    String sessionKEY,
            @WebParam(name = "CHANNEL", partName = "CHANNEL")
                    String channel,
            @WebParam(name = "TRX_TYPE", partName = "TRX_TYPE")
                    String trxTYPE,
            @WebParam(name = "REJECTED_TRX_IND", partName = "REJECTED_TRX_IND")
                    String rejectedTRXIND,
            @WebParam(name = "REJECTED_DATE", partName = "REJECTED_DATE")
                    String rejectedDATE,
            @WebParam(name = "REJECTED_TYPE_CD", partName = "REJECTED_TYPE_CD")
                    String rejectedTYPECD,
            @WebParam(name = "RESEND_DUE_TO_FAILURE_IND", partName = "RESEND_DUE_TO_FAILURE_IND")
                    String resendDUETOFAILUREIND,
            @WebParam(name = "HEADER_USER_AGENT", partName = "HEADER_USER_AGENT")
                    String headerUSERAGENT,
            @WebParam(name = "HTTP_HEADER_FIELDS", partName = "HTTP_HEADER_FIELDS")
                    String httpHEADERFIELDS,
            @WebParam(name = "SEND_ALERT", partName = "SEND_ALERT")
                    String sendALERT,
            @WebParam(name = "WEB_DEVICE_ID", partName = "WEB_DEVICE_ID")
                    String webDEVICEID,
            @WebParam(name = "CALC_WEB_DEVICE_ID", partName = "CALC_WEB_DEVICE_ID")
                    String calcWEBDEVICEID,
            @WebParam(name = "PARTY_TYPE", partName = "PARTY_TYPE")
                    String partyTYPE,
            @WebParam(name = "CLIENT_SCREEN_RESOLUTION", partName = "CLIENT_SCREEN_RESOLUTION")
                    String clientSCREENRESOLUTION,
            @WebParam(name = "webSessionLoginOut", mode = WebParam.Mode.OUT, partName = "webSessionLoginOut")
                    Holder<FFWSEvaluateWebSessionLoginV12WebSessionLoginOutTupleType> webSessionLoginOut);
